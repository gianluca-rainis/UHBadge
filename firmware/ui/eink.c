...
static const uint8_t* lastBuf = NULL;
...
static const uint8_t LUT_PARTIAL[159] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x00, 0x00, 0x00, 0x22, 0x17, 0x41, 0xB0, 0x32, 0x36
};
...
void einkUpdate(bool partial) {
    ...
    if (partial && lastBuf != NULL) {
        einkSyncOldRam(lastBuf);
    }
}
